...
#xwalk修复
#sed -i 's/download.01.org\/crosswalk\/releases\/crosswalk\/android\/maven2/raw.githubusercontent.com\/owen10086\/TVBoxDIY~UP\/main/g' $CURRENT_DIR/$DIR/build.gradle
#名称修改
